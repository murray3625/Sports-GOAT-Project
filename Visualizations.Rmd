...
golf.filter = data[data$Sport == "Chess",]
...
tbl.2.data <- cbind(data.2[-3, 1], lengths)
...
data.combined.2[c(2, 5, 7, 8), 4] <- "Yes"
...
ggplot(data = data.combined.2, 
  ...
  scale_shape_manual(values = seq(9)) + 
...
data.combined.3 <- data.combined.2[-3,]
