...
df.list <- list(soccer, cricket, tennis, tennis.2, basketball, basketball.3, football, hockey, golf)
...
strings = list("Soccer", "Cricket", "Tennis", "Tennis 2", "Basketball", "Basketball 3", "Football", "Hockey", "Golf")
iterator = 0
