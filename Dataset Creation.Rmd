...
df.list <- list(soccer, soccer.2, cricket, tennis, tennis.2, basketball,
                basketball.2, baseball, baseball.2, football, football.2,
                hockey, golf, golf.2)
...
strings = list("Soccer", "Soccer 2", "Cricket", "Tennis", "Tennis 2",
...
df.goats$Sport <- str_replace(df.goats$Sports, "Golf 2", "Golf")
