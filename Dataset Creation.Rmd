...
df.list <- list(soccer, cricket, tennis, basketball, football, hockey, golf)
...
strings = list("Soccer", "Cricket", "Tennis", "Basketball", "Football", "Hockey", "Golf")
iterator = 0
...
f1 <- ggplot(data = df.goats.subset, 
  ...
  labs(x = "Year", 
       ...
       title = "Number of Potential GOATs by Year (Version 4.0)",
       caption = "Figure 1") + 
  theme_bw() +
