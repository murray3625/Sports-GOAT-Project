...
Years.Active <- c("2003-present", "1984-1993, 1995-1998, 2001-2003", "1984-2003", "1985-2004",
 ...
 basketball.3 <- create.df(Players, Years.Active)
...
df.list <- list(soccer, soccer.2, cricket, tennis, tennis.2, basketball.2, basketball.3, baseball, baseball.2, football, football.2, hockey, golf)
...
strings = list("Soccer", "Soccer 2", "Cricket", "Tennis", "Tennis 2", "Basketball 2", "Basketball 3", "Baseball", "Baseball 2", "Football", "Football 2", "Hockey", "Golf")
iterator = 0
...
# names of sports and iterator for the list
strings = list("Soccer", "Soccer 2", "Cricket", "Tennis", "Tennis 2", "Basketball", "Basketball 3", "Baseball", "Baseball 2", "Football", "Football 2", "Hockey", "Golf")
iterator = 0
...
df.goats$Sport <- str_replace(df.goats$Sport, "Basketball 3", "Basketball")
