...
* Tennis - Players were ranked based on the number of majors they won. The four majors, also known as Grand Slam events, in tennis include the Australian Open, the French Open, Wimbledon, and the US Open, each of which is played annually. These tournaments became open to professionals in 1968, thus marking the advent of the Open Era in tennis as well as a significant shift and maturation of the sport [@TC]. Today, tennis player accomplishments are often discussed in the context of Open Era record, with one of the most prominent ones being Grand Slam or major titles. 


* Basketball - Players were ranked based on their Value over Replacement Player. (Explain this metric)
* Baseball - Players were based on their MVP shares. (Explain this metric)
* Football - Players were ranked based on the number of MVP's they won. More specifically, the list includes players more than 1 NFL MVP.  
* Ice Hockey - TBD
* Golf - Players were ranked based on the number of majors they won. More specifically, we included players who have won at least 5 majors. Addiiontally, we ranked players based on the number of PGA Tour wins that they have. 
